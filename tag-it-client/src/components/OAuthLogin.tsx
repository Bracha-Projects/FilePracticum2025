...
import { AuthResponse, OAuthLoginRequest } from "@/types/AuthResponse"
...
const OAuthLogin: React.FC<OAuthLoginProps> = ({ onSuccess }) => {
    ...
    const googleLogin = useGoogleLogin({
        onSuccess: async (tokenResponse) => {
            ...
            await handleOAuthLogin("Google", accessToken)
        },
        onError: () => {
        ...
        <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
                <Button
                    ...
                    className="border-[#A8EBC7]/50 hover:border-[#A8EBC7] hover:bg-[#A8EBC7]/10"
                >
                    {isLoading === "google" ? (
                        <div className="w-4 h-4 border-2 border-[#4B6982] border-t-transparent rounded-full animate-spin" />
                    ) : (
                ...
                >
                    {isLoading === "github" ? (
                        ...
                        <svg className="w-4 h-4 mr-2" fill="#4B6982" viewBox="0 0 24 24">
